...
public class Main {
	...
	private static final String code = "AQBOuSdeksxXg0vp5MHCAApNC1h71GC4E2fizMMMb9okXiZLb84Ar_S7dWPIcBjNDJnfV9lE60gZVH-3xUZyu4H4FKStgXc7p_rJb9KLgEiFff7Ad6fIIBV2Q-z1hbXBPQvdh30EtmjfpkRueM7ztgcFA1s7oY7GL1PTDlNrLYflKb5G5NPBoLEhZeTqzD1_MngsxyR4d3aTS80V-f_oFWDm3xTgLXaTIz9M_AQinSkf_wyPtLMdKsMl";
	...
	public static void main(String[] args) {
		...
		System.out.println();
		if (!currentlyPlaying.equalsIgnoreCase("")) {
